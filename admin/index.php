...
<div class="grid grid-3">
    <a href="<?= h(BASE_URL) ?>rooms.php" style="text-decoration: none; color: inherit;">
    ...
    <a href="<?= h(BASE_URL) ?>room_types.php" style="text-decoration: none; color: inherit;">
        <div class="marble-card" style="text-align: center; transition: all 0.3s;">
    ...
    <a href="<?= h(BASE_URL) ?>guests.php" style="text-decoration: none; color: inherit;">
        <div class="marble-card" style="text-align: center; transition: all 0.3s;">
    ...
    <a href="<?= h(BASE_URL) ?>bookings.php" style="text-decoration: none; color: inherit;">
        <div class="marble-card" style="text-align: center; transition: all 0.3s;">
    ...
    <a href="<?= h(BASE_URL) ?>report.php" style="text-decoration: none; color: inherit;">
        <div class="marble-card" style="text-align: center; transition: all 0.3s;">
