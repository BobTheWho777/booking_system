...
$pageTitle = 'О нас — Мини-гостиница «Олимп»';
require __DIR__ . '/includes/header.php';
?>

<section class="hero-section">
    <h1>Ο ΜΥΘΟΣ ΤΟΥ «ΌΛΥΜΠΟΣ»</h1>
    <p style="font-size: 1.5rem; font-style: italic; font-family: 'Cormorant Garamond', serif;">Легенда гостеприимства в сердце древнегреческой культуры</p>
</section>

<div class="container">
    <div class="marble-card" style="margin-bottom: 2rem;">
        <h2 style="text-align: center; margin-bottom: 1.5rem;">Добро пожаловать в дом богов</h2>
        <p style="font-size: 1.2rem; line-height: 1.8; text-align: justify;">
            ...
            Мы создали пространство, где каждый гость чувствует себя как на вершине Олимпа, среди богов и героев 
            античных мифов. Наши интерьеры украшены элементами классической греческой архитектуры: мраморные колонны, 
            золотые акценты и средиземноморские оттенки создают атмосферу благородства и спокойствия.
        </p>
        <p style="font-size: 1.2rem; line-height: 1.8; text-align: justify;">
            Мы предлагаем комфортабельные номера различных категорий — от уютных одноместных комнат до просторных 
            люксов для семейного отдыха. Каждый номер оборудован всем необходимым для приятного пребывания: 
            современной мебелью, качественным постельным бельём, бесплатным Wi-Fi и кондиционером.
        </p>
    </div>
    ...
    <div class="grid grid-2" style="margin-bottom: 2rem;">
        <div class="marble-card">
            ...
            <p style="font-size: 1.1rem; line-height: 1.7; text-align: justify;">
                ...
                замедляется, и вы можете насладиться каждым моментом вашего отдыха.
            </p>
        </div>
        ...
        <div class="marble-card">
            ...
            <ul style="font-size: 1.1rem; line-height: 1.8; padding-left: 1.5rem;">
                ...
                <li><strong>Чистота:</strong> Безупречный порядок в каждом номере</li>
                <li><strong>Внимание:</strong> Индивидуальный подход к каждому посетителю</li>
                <li><strong>Безопасность:</strong> Забота о вашем спокойствии 24/7</li>
            </ul>
        </div>
    </div>
    ...
    <div class="marble-card" style="text-align: center;">
        ...
        <p style="font-size: 1.2rem; color: var(--text-secondary); margin-bottom: 2rem;">
            Забронируйте номер прямо сейчас и почувствуйте себя богом на Олимпе!
        </p>
        <a href="booking.php" class="btn-greek" style="display: inline-block; text-decoration: none;">
            Забронировать номер
        </a>
    </div>
</div>
